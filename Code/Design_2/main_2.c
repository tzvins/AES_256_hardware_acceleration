...
// XPAR_ENCDEC6_IP_0_S00_AXI_BASEADDR = 0x44A00000
// base addresses for hardware registers:
#define INPUT_ADDR			XPAR_ENCDEC6_IP_0_S00_AXI_BASEADDR
#define KEY_ADDR 			XPAR_ENCDEC6_IP_0_S00_AXI_BASEADDR + 16 	//4*4
#define OUT_ADDR 			XPAR_ENCDEC6_IP_0_S00_AXI_BASEADDR + 48	//4*12
#define CNTL_ADDR 			XPAR_ENCDEC6_IP_0_S00_AXI_BASEADDR + 64	//4*16 LOAD-0,RESET-1,ENC_EN-2
#define DONE_ADDR 			XPAR_ENCDEC6_IP_0_S00_AXI_BASEADDR + 68	//4*17
